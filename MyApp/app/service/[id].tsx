...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: '#FFFDF8' }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', padding: 28, backgroundColor: '#FFFDF8' }, loading: { color: '#7B7474', fontSize: 14, marginTop: 12 }, errorTitle: { color: '#44383B', fontSize: 18, fontWeight: '800', marginTop: 12 }, errorText: { color: '#86777B', fontSize: 14, textAlign: 'center', marginTop: 5 }, backHome: { marginTop: 18, backgroundColor: '#4D948A', paddingHorizontal: 22, paddingVertical: 10, borderRadius: 20 }, backHomeText: { color: '#FFF', fontWeight: '800' },
  header: { height: 64, paddingHorizontal: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#FFFDF8', borderBottomWidth: 1, borderBottomColor: '#EEEAE2' }, headerButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#F4F1EA', alignItems: 'center', justifyContent: 'center' }, brand: { flexDirection: 'row', alignItems: 'center', gap: 7 }, logo: { width: 34, height: 34, borderRadius: 17, borderWidth: 1, borderColor: '#E7B4C2', alignItems: 'center', justifyContent: 'center' }, brandName: { color: '#363032', fontSize: 17, fontWeight: '700' }, brandAccent: { color: '#B95070' }, location: { flexDirection: 'row', alignItems: 'center', gap: 2 }, locationText: { color: '#76817E', fontSize: 11 }, headerRight: { flexDirection: 'row', alignItems: 'center', gap: 7 }, notificationDot: { position: 'absolute', right: 6, top: 6, width: 5, height: 5, borderRadius: 3, backgroundColor: '#E45F70' }, avatar: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#DDEEEA', alignItems: 'center', justifyContent: 'center' }, avatarText: { color: '#397B73', fontWeight: '800' },
  scrollContent: { paddingBottom: 18 }, galleryRow: { height: 256, margin: 14, flexDirection: 'row', gap: 8 }, gallerySection: { flex: 1, borderRadius: 20, overflow: 'hidden', backgroundColor: '#E8EEE9' }, heroImage: { width: '100%', height: '100%' }, favoriteButton: { position: 'absolute', top: 11, right: 11, width: 39, height: 39, borderRadius: 20, backgroundColor: 'rgba(255,255,255,.94)', alignItems: 'center', justifyContent: 'center' }, bestSeller: { position: 'absolute', left: 10, bottom: 10, flexDirection: 'row', alignItems: 'center', gap: 4, backgroundColor: '#FFF3D8', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 9 }, bestSellerText: { color: '#96651F', fontSize: 11, fontWeight: '800' }, counter: { position: 'absolute', right: 10, bottom: 10, backgroundColor: 'rgba(42,50,48,.68)', paddingHorizontal: 8, paddingVertical: 5, borderRadius: 9 }, counterText: { color: '#FFF', fontSize: 11, fontWeight: '700' }, verticalThumbnails: { width: 69, gap: 7 }, verticalThumbnailWrap: { flex: 1, padding: 2, borderRadius: 13, borderWidth: 2, borderColor: '#E8E3DB', overflow: 'hidden', backgroundColor: '#FFF' }, verticalThumbnailActive: { borderColor: '#4D948A' }, verticalThumbnail: { width: '100%', height: '100%', borderRadius: 9 }, moreOverlay: { position: 'absolute', top: 2, right: 2, bottom: 2, left: 2, borderRadius: 9, backgroundColor: 'rgba(49,58,56,.48)', alignItems: 'center', justifyContent: 'center' }, moreText: { color: '#FFF', fontSize: 18, fontWeight: '800' },
  content: { paddingHorizontal: 17 }, categoryRating: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, categoryPill: { backgroundColor: '#E3F1EE', paddingHorizontal: 10, paddingVertical: 5, borderRadius: 10 }, categoryText: { color: '#397B73', fontSize: 11, fontWeight: '900', letterSpacing: .7 }, rating: { flexDirection: 'row', alignItems: 'center', gap: 3 }, ratingValue: { color: '#3D3638', fontSize: 14, fontWeight: '800' }, reviewCount: { color: '#92898B', fontSize: 11 }, title: { color: '#30282A', fontSize: 25, fontWeight: '800', marginTop: 10 }, priceLine: { flexDirection: 'row', alignItems: 'center', gap: 18, marginTop: 7 }, price: { color: '#D15D68', fontSize: 22, fontWeight: '900' }, duration: { flexDirection: 'row', alignItems: 'center', gap: 5, backgroundColor: '#E7F3F0', paddingHorizontal: 10, paddingVertical: 6, borderRadius: 12 }, durationText: { color: '#397B73', fontSize: 13, fontWeight: '700' },
  recommendation: { marginTop: 16, minHeight: 68, padding: 12, borderRadius: 17, backgroundColor: '#F4EFF9', borderWidth: 1, borderColor: '#E9DDF2', flexDirection: 'row', alignItems: 'center', gap: 10 }, recommendIcon: { width: 38, height: 38, borderRadius: 19, backgroundColor: '#FCE8EC', alignItems: 'center', justifyContent: 'center' }, recommendCopy: { flex: 1 }, recommendTitle: { color: '#57445D', fontSize: 14, fontWeight: '800' }, recommendText: { color: '#807184', fontSize: 11, lineHeight: 17, marginTop: 2 },
  descriptionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 19 }, sectionTitle: { color: '#342D2F', fontSize: 17, fontWeight: '800' }, expandButton: { flexDirection: 'row', alignItems: 'center', gap: 2 }, expandText: { color: '#397B73', fontSize: 12, fontWeight: '700' }, description: { color: '#776E70', fontSize: 13, lineHeight: 22, marginTop: 8 }, benefitTitle: { marginTop: 20, marginBottom: 10 }, benefitList: { gap: 8, paddingBottom: 4 }, benefitCard: { width: 94, minHeight: 91, padding: 9, borderRadius: 15, borderWidth: 1, alignItems: 'center' }, benefitIcon: { width: 35, height: 35, borderRadius: 18, alignItems: 'center', justifyContent: 'center' }, benefitName: { color: '#4A4143', fontSize: 12, fontWeight: '800', marginTop: 6 }, benefitSubtitle: { color: '#8A7F82', fontSize: 11, marginTop: 2, textAlign: 'center' },
  processSection: { marginTop: 24, paddingTop: 18, borderTopWidth: 1, borderTopColor: '#E8E3DC' }, processHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 16 }, processTime: { flexDirection: 'row', alignItems: 'center', gap: 4 }, processTimeText: { color: '#4D7F78', fontSize: 12, fontWeight: '600' }, steps: { paddingLeft: 2 }, stepRow: { flexDirection: 'row', minHeight: 79 }, stepRail: { width: 36, alignItems: 'center' }, stepNumber: { width: 27, height: 27, borderRadius: 14, backgroundColor: '#DCEDE9', alignItems: 'center', justifyContent: 'center' }, stepNumberAlt: { backgroundColor: '#F2E7D2' }, stepNumberText: { color: '#3E6F68', fontSize: 13, fontWeight: '800' }, stepLine: { width: 1, flex: 1, backgroundColor: '#D9D6CF', marginVertical: 4 }, stepContent: { flex: 1, paddingLeft: 10, paddingBottom: 17 }, stepTitleRow: { flexDirection: 'row', alignItems: 'flex-start', justifyContent: 'space-between', gap: 8 }, stepTitle: { flex: 1, color: '#3A3234', fontSize: 14, fontWeight: '700', lineHeight: 22 }, stepMinutes: { color: '#9A7A43', fontSize: 11, marginTop: 2 }, stepDescription: { color: '#7E7577', fontSize: 12, lineHeight: 19, marginTop: 4, paddingRight: 5 },
  detailSection: { marginTop: 25, paddingTop: 18, borderTopWidth: 1, borderTopColor: '#E8E3DC' }, simpleHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, simpleLink: { color: '#B8506E', fontSize: 12, fontWeight: '600' }, emptySection: { color: '#847A7D', fontSize: 13, paddingVertical: 12 },
  staffList: { gap: 9 }, staffCard: { width: 185, minHeight: 83, padding: 10, borderWidth: 1, borderColor: '#E5E1DA', backgroundColor: '#FFFDF9', flexDirection: 'row', alignItems: 'center', gap: 9 }, staffCardSelected: { borderColor: '#C25573', backgroundColor: '#FFF3F6' }, staffAvatar: { width: 52, height: 52, borderRadius: 26 }, staffAvatarFallback: { width: 52, height: 52, borderRadius: 26, backgroundColor: '#E1EFEC', alignItems: 'center', justifyContent: 'center' }, staffInitial: { color: '#397B73', fontSize: 18, fontWeight: '800' }, staffInfo: { flex: 1 }, staffName: { color: '#3A3234', fontSize: 14, fontWeight: '800' }, staffRating: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 3 }, staffRatingText: { color: '#665B5E', fontSize: 12, fontWeight: '700' }, staffSpecialty: { color: '#8A7E81', fontSize: 11, marginTop: 4 },
  reviewList: { gap: 10 }, reviewCard: { width: 265, minHeight: 122, padding: 12, borderWidth: 1, borderColor: '#E8E3DC', backgroundColor: '#FFF' }, reviewHeader: { flexDirection: 'row', alignItems: 'center' }, reviewAvatar: { width: 36, height: 36, borderRadius: 18 }, reviewAvatarFallback: { width: 36, height: 36, borderRadius: 18, backgroundColor: '#F2E7D6', alignItems: 'center', justifyContent: 'center' }, reviewInitial: { color: '#946B2E', fontWeight: '800' }, reviewIdentity: { flex: 1, marginLeft: 8 }, reviewName: { color: '#3D3436', fontSize: 13, fontWeight: '800' }, reviewStars: { flexDirection: 'row', marginTop: 3 }, reviewDate: { color: '#A1989A', fontSize: 11 }, reviewComment: { color: '#71676A', fontSize: 12, lineHeight: 19, marginTop: 9 }, reviewImage: { width: 48, height: 48, marginTop: 8 }, noReview: { height: 58, backgroundColor: '#F1F6F4', flexDirection: 'row', alignItems: 'center', paddingHorizontal: 13, gap: 9 }, noReviewText: { color: '#687B77', fontSize: 12 },
  relatedList: { gap: 10 }, relatedCard: { width: 132, paddingBottom: 8, backgroundColor: '#FAF7EF', borderWidth: 1, borderColor: '#EEE8DA' }, relatedImage: { width: 130, height: 96 }, relatedImagePlaceholder: { width: 130, height: 96, backgroundColor: '#E5EFEC' }, relatedName: { color: '#443A3D', fontSize: 12, fontWeight: '700', marginTop: 7, paddingHorizontal: 7 }, relatedPrice: { color: '#B8506E', fontSize: 13, fontWeight: '800', marginTop: 3, paddingHorizontal: 7 },
  footer: { paddingHorizontal: 17, paddingTop: 12, paddingBottom: 8, borderTopWidth: 1, borderTopColor: '#EBE7DE', backgroundColor: '#FFFDF9', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, footerLabel: { color: '#91878A', fontSize: 11 }, footerPrice: { color: '#C25573', fontSize: 18, fontWeight: '900', marginTop: 2 }, bookButton: { minWidth: 190, height: 48, borderRadius: 24, backgroundColor: '#C25573', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8 }, bookPressed: { opacity: .75 }, bookText: { color: '#FFF', fontSize: 15, fontWeight: '800' },
});
