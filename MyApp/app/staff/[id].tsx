...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.cream, gap: 10, padding: 24 }, loading: { color: COLORS.muted, fontSize: 14 }, errorText: { color: '#7D5550', fontSize: 14, textAlign: 'center' }, backButton: { borderRadius: 16, backgroundColor: COLORS.primary, paddingHorizontal: 20, paddingVertical: 10 }, backText: { color: '#FFF', fontSize: 14, fontWeight: '700' },
  topBar: { height: 66, paddingHorizontal: 14, backgroundColor: '#FFF3F5', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, iconButton: { width: 38, height: 38, borderRadius: 19, backgroundColor: 'rgba(255,255,255,.92)', alignItems: 'center', justifyContent: 'center' }, actions: { flexDirection: 'row', gap: 7 }, brand: { position: 'absolute', left: '38%', flexDirection: 'row', alignItems: 'center', gap: 6 }, brandIcon: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#FFE5EB', alignItems: 'center', justifyContent: 'center' }, brandName: { color: COLORS.ink, fontSize: 16, fontWeight: '800', fontFamily: 'serif' }, brandAccent: { color: COLORS.primary }, brandTagline: { color: COLORS.muted, fontSize: 11 },
  profileHero: { paddingHorizontal: 15, paddingTop: 10, paddingBottom: 22, backgroundColor: '#FFF3F5', flexDirection: 'row' }, photoWrap: { width: '42%', height: 238, borderRadius: 14, overflow: 'hidden', backgroundColor: COLORS.blush }, photo: { width: '100%', height: '100%', resizeMode: 'cover' }, photoFallback: { alignItems: 'center', justifyContent: 'center', backgroundColor: COLORS.sageSoft }, photoInitial: { color: COLORS.sage, fontSize: 54, fontWeight: '800' }, statusPill: { position: 'absolute', left: 8, bottom: 8, paddingHorizontal: 8, paddingVertical: 6, borderRadius: 12, backgroundColor: 'rgba(255,255,255,.94)', flexDirection: 'row', alignItems: 'center', gap: 5 }, statusDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: COLORS.green }, statusDotOff: { backgroundColor: COLORS.gold }, statusText: { color: COLORS.green, fontSize: 11, fontWeight: '800' }, statusTextOff: { color: '#956E28' }, profileInfo: { flex: 1, paddingLeft: 15, paddingTop: 8 }, eyebrow: { color: COLORS.primary, fontSize: 11, fontWeight: '800', letterSpacing: .8 }, name: { color: COLORS.ink, fontSize: 26, lineHeight: 30, fontWeight: '800', marginTop: 7, fontFamily: 'serif' }, role: { color: COLORS.lavender, fontSize: 11, lineHeight: 17, fontWeight: '700', marginTop: 3 }, ratingRow: { marginTop: 9, flexDirection: 'row', alignItems: 'center', gap: 4 }, rating: { color: COLORS.ink, fontSize: 14, fontWeight: '800' }, reviewCount: { color: COLORS.muted, fontSize: 11 }, signature: { marginTop: 12 }, signatureLine: { width: 25, height: 2, borderRadius: 1, backgroundColor: COLORS.gold }, signatureText: { color: COLORS.muted, fontSize: 11, lineHeight: 16, fontStyle: 'italic', marginTop: 5 },
  stats: { marginTop: 13, flexDirection: 'row', gap: 5 }, stat: { flex: 1, minHeight: 60, paddingVertical: 6, backgroundColor: 'rgba(255,255,255,.76)', alignItems: 'center', justifyContent: 'center' }, statIcon: { width: 24, height: 24, alignItems: 'center', justifyContent: 'center' }, statValue: { color: COLORS.ink, fontSize: 11, fontWeight: '800', textAlign: 'center' }, statLabel: { color: COLORS.muted, fontSize: 11, marginTop: 1, textAlign: 'center' }, statDivider: { width: 1, height: 35, backgroundColor: COLORS.line },
  section: { marginTop: 12, paddingHorizontal: 18, paddingVertical: 18, backgroundColor: '#FFF' }, expertiseSection: { marginTop: 0, paddingBottom: 13 }, introSection: { marginTop: 0, paddingTop: 13, borderTopWidth: 1, borderTopColor: '#F5ECEC' }, sectionHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }, sectionTitleWrap: { flexDirection: 'row', alignItems: 'center', gap: 8 }, sectionTitle: { color: COLORS.ink, fontSize: 15, fontWeight: '800' }, countPill: { minWidth: 24, height: 20, paddingHorizontal: 6, backgroundColor: COLORS.blush, alignItems: 'center', justifyContent: 'center' }, countText: { color: COLORS.primary, fontSize: 11, fontWeight: '800' }, tags: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, tag: { maxWidth: 145, height: 31, borderRadius: 16, paddingHorizontal: 12, alignItems: 'center', justifyContent: 'center' }, tagPink: { backgroundColor: COLORS.blush }, tagSage: { backgroundColor: COLORS.sageSoft }, tagLavender: { backgroundColor: COLORS.lavenderSoft }, tagGold: { backgroundColor: COLORS.goldSoft }, tagText: { fontSize: 11, fontWeight: '700' }, tagTextPink: { color: COLORS.primaryDark }, tagTextSage: { color: COLORS.sage }, tagTextLavender: { color: COLORS.lavender }, tagTextGold: { color: '#94691E' },
  introduction: { color: '#665E67', fontSize: 13, lineHeight: 22 }, quote: { marginTop: 12, paddingVertical: 9, paddingHorizontal: 10, backgroundColor: COLORS.goldSoft, flexDirection: 'row', alignItems: 'center', gap: 7 }, quoteText: { flex: 1, color: '#7E6740', fontSize: 11, lineHeight: 18, fontStyle: 'italic' }, portfolio: { gap: 9 }, workImage: { width: 128, height: 116, borderRadius: 5, borderWidth: 1, borderColor: COLORS.line, backgroundColor: '#F2EBE7' }, featured: { position: 'absolute', left: 7, bottom: 7, paddingHorizontal: 7, paddingVertical: 4, backgroundColor: 'rgba(45,40,48,.68)' }, featuredText: { color: '#FFF', fontSize: 11, fontWeight: '700' },
  reviewCard: { marginTop: 8, padding: 12, borderWidth: 1, borderColor: COLORS.line, borderRadius: 5 }, reviewHeader: { flexDirection: 'row', alignItems: 'center' }, reviewAvatar: { width: 38, height: 38, borderRadius: 19 }, reviewFallback: { width: 38, height: 38, borderRadius: 19, backgroundColor: COLORS.lavenderSoft, alignItems: 'center', justifyContent: 'center' }, reviewInitial: { color: COLORS.lavender, fontWeight: '800' }, reviewIdentity: { flex: 1, marginLeft: 9 }, reviewName: { color: COLORS.ink, fontSize: 13, fontWeight: '800' }, stars: { flexDirection: 'row', marginTop: 3 }, date: { color: '#9B9093', fontSize: 11 }, comment: { color: '#6E656D', fontSize: 12, lineHeight: 20, marginTop: 9, paddingLeft: 47 }, empty: { height: 62, paddingHorizontal: 12, backgroundColor: COLORS.sageSoft, flexDirection: 'row', alignItems: 'center', gap: 9 }, emptyText: { color: COLORS.sage, fontSize: 12 },
  footer: { position: 'absolute', left: 0, right: 0, bottom: 0, paddingHorizontal: 14, paddingTop: 11, paddingBottom: 12, backgroundColor: 'rgba(255,255,255,.97)', borderTopWidth: 1, borderTopColor: COLORS.line, flexDirection: 'row', gap: 9 }, messageButton: { height: 48, width: 105, borderRadius: 16, backgroundColor: COLORS.blush, borderWidth: 1, borderColor: '#F5DDE4', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }, messageText: { color: COLORS.primaryDark, fontSize: 13, fontWeight: '800' }, bookButton: { flex: 1, height: 48, borderRadius: 16, backgroundColor: COLORS.primaryDark, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, shadowColor: COLORS.primaryDark, shadowOffset: { width: 0, height: 5 }, shadowOpacity: .18, shadowRadius: 9, elevation: 4 }, bookText: { color: '#FFF', fontSize: 13, fontWeight: '800' }, pressed: { opacity: .86, transform: [{ scale: .99 }] },
});
