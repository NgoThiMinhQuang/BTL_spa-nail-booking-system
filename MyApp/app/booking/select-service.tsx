...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: COLORS.background }, center: { flex: 1, alignItems: 'center', justifyContent: 'center', gap: 10, backgroundColor: COLORS.background }, stateText: { color: COLORS.muted, fontSize: 13 },
  ...
  progress: { height: 42, marginTop: 6, paddingHorizontal: 39, flexDirection: 'row', alignItems: 'center' }, progressPart: { flex: 1, flexDirection: 'row', alignItems: 'center' }, progressLine: { height: 2, flex: 1, backgroundColor: '#E5DFE3' }, step: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#EEECEF', alignItems: 'center', justifyContent: 'center' }, stepActive: { backgroundColor: COLORS.primary }, stepNumber: { color: COLORS.text, fontSize: 14, fontWeight: '800' }, stepNumberActive: { color: '#FFF' },
  stepLabels: { marginHorizontal: 18, flexDirection: 'row' }, stepLabel: { flex: 1, color: COLORS.muted, fontSize: 11, lineHeight: 15, textAlign: 'center' }, stepLabelActive: { color: COLORS.text, fontWeight: '800' },
  content: { paddingHorizontal: 14, paddingTop: 17, paddingBottom: 100 }, error: { padding: 12, marginBottom: 10, backgroundColor: COLORS.primarySoft, flexDirection: 'row', alignItems: 'center', gap: 8 }, errorText: { flex: 1, color: COLORS.primaryDark, fontSize: 12 },
  staffCard: { minHeight: 194, padding: 9, backgroundColor: '#FFF', flexDirection: 'row', borderWidth: 1, borderColor: '#F4E8E9' }, staffPhoto: { width: '37%', minHeight: 176, resizeMode: 'cover' }, fallback: { backgroundColor: COLORS.primarySoft, alignItems: 'center', justifyContent: 'center' }, initial: { color: COLORS.primary, fontSize: 38, fontWeight: '800' }, staffInfo: { flex: 1, paddingLeft: 14, paddingTop: 4 }, staffNameRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, staffName: { maxWidth: '62%', color: COLORS.text, fontSize: 19, fontWeight: '800', fontFamily: 'serif' }, changeButton: { paddingHorizontal: 9, paddingVertical: 7, backgroundColor: COLORS.primarySoft }, changeText: { color: COLORS.primaryDark, fontSize: 11, fontWeight: '800' }, ratingRow: { marginTop: 9, flexDirection: 'row', alignItems: 'center', gap: 4 }, rating: { color: COLORS.text, fontSize: 14, fontWeight: '800' }, reviews: { color: COLORS.muted, fontSize: 11 }, staffMeta: { marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 7 }, staffMetaText: { flex: 1, color: COLORS.muted, fontSize: 11 }, quote: { minHeight: 49, marginTop: 11, paddingHorizontal: 9, backgroundColor: COLORS.primarySoft, flexDirection: 'row', alignItems: 'center', gap: 6 }, quoteText: { flex: 1, color: COLORS.muted, fontSize: 11, lineHeight: 15, fontStyle: 'italic' },
  staffPicker: { marginTop: 10, paddingVertical: 13, backgroundColor: '#FFF', borderTopWidth: 1, borderBottomWidth: 1, borderColor: COLORS.line }, pickerTitle: { paddingHorizontal: 13, color: COLORS.text, fontSize: 15, fontWeight: '800' }, pickerSubtitle: { paddingHorizontal: 13, marginTop: 3, color: COLORS.muted, fontSize: 11 }, staffOptions: { paddingHorizontal: 13, paddingTop: 12, gap: 9 }, staffOption: { width: 78, paddingVertical: 8, alignItems: 'center', borderWidth: 1, borderColor: '#EEE7E9', backgroundColor: '#FFF' }, staffOptionSelected: { borderColor: COLORS.primary, backgroundColor: '#FFF8FA' }, optionPhotoWrap: { width: 52, height: 52 }, optionPhoto: { width: 52, height: 52, borderRadius: 26, resizeMode: 'cover' }, optionInitial: { color: COLORS.primary, fontSize: 18, fontWeight: '800' }, optionCheck: { position: 'absolute', right: -1, bottom: -1, width: 17, height: 17, borderRadius: 9, backgroundColor: COLORS.primary, borderWidth: 2, borderColor: '#FFF', alignItems: 'center', justifyContent: 'center' }, optionName: { width: 66, marginTop: 7, color: COLORS.text, fontSize: 11, fontWeight: '700', textAlign: 'center' }, optionNameSelected: { color: COLORS.primaryDark }, optionRating: { marginTop: 3, flexDirection: 'row', alignItems: 'center', gap: 2 }, optionRatingText: { color: COLORS.muted, fontSize: 11, fontWeight: '700' },
  sectionHeader: { marginTop: 22, marginBottom: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, sectionTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 9 }, sectionIcon: { width: 30, height: 30, borderRadius: 15, backgroundColor: COLORS.primarySoft, alignItems: 'center', justifyContent: 'center' }, sectionTitle: { color: COLORS.text, fontSize: 18, fontWeight: '800' }, seeAll: { color: COLORS.primary, fontSize: 12, fontWeight: '700' },
  serviceList: { gap: 9 }, serviceCard: { minHeight: 112, padding: 8, backgroundColor: '#FFF', borderWidth: 1, borderColor: 'transparent', flexDirection: 'row', alignItems: 'center' }, serviceCardSelected: { borderColor: COLORS.primary, backgroundColor: '#FFFAFB' }, serviceImage: { width: 86, height: 94, resizeMode: 'cover' }, serviceInfo: { flex: 1, alignSelf: 'stretch', paddingHorizontal: 12, paddingVertical: 5 }, serviceName: { color: COLORS.text, fontSize: 15, fontWeight: '800' }, description: { color: COLORS.muted, fontSize: 11, lineHeight: 17, marginTop: 5 }, serviceBottom: { marginTop: 'auto', flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, price: { color: COLORS.primaryDark, fontSize: 15, fontWeight: '800' }, duration: { flexDirection: 'row', alignItems: 'center', gap: 4 }, durationText: { color: COLORS.muted, fontSize: 11 }, radio: { width: 26, height: 26, borderRadius: 13, marginRight: 4, borderWidth: 2, borderColor: '#D6D2D8', alignItems: 'center', justifyContent: 'center' }, radioSelected: { borderColor: COLORS.primary, backgroundColor: COLORS.primary }, pressed: { opacity: .82 }, empty: { paddingVertical: 55, alignItems: 'center', gap: 8 },
