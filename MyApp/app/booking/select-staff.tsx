...
const styles = StyleSheet.create({
  ...
  subtitle: { color: PALETTE.muted, fontSize: 14, lineHeight: 21, marginTop: 4, textAlign: 'center' },
  ...
  categoryText: { color: '#746669', fontSize: 14, fontWeight: '700' },
  ...
  favoriteText: { color: '#A66B22', fontSize: 11, fontWeight: '700' },
  specialty: { color: PALETTE.muted, fontSize: 14, marginTop: 4 },
  ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 7 },
  rating: { color: PALETTE.text, fontSize: 14, fontWeight: '800' },
  reviews: { color: PALETTE.muted, fontSize: 13 },
  detailRow: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 5 },
  detail: { flex: 1, color: '#716568', fontSize: 13 },
  center: { minHeight: 300, alignItems: 'center', justifyContent: 'center', gap: 10 },
  stateText: { color: PALETTE.muted, fontSize: 14 },
  ...
  messageText: { flex: 1, color: '#7D5159', fontSize: 14 },
  retry: { color: PALETTE.primary, fontSize: 14, fontWeight: '800' },
  promise: { marginTop: 4, borderRadius: 17, paddingVertical: 17, alignItems: 'center', backgroundColor: PALETTE.primarySoft },
  promiseText: { color: '#9A747A', fontSize: 14, fontStyle: 'italic', marginTop: 4 },
  promiseBrand: { color: PALETTE.primary, fontSize: 13, marginTop: 4 },
});
