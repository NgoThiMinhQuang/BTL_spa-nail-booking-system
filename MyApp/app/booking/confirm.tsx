...
const styles = StyleSheet.create({
  safeArea: { flex: 1, backgroundColor: COLORS.background }, center: { flex: 1, backgroundColor: COLORS.background, alignItems: 'center', justifyContent: 'center', gap: 10 }, stateText: { color: COLORS.muted, fontSize: 14, textAlign: 'center' },
  ...
  progress: { height: 43, marginTop: 5, marginHorizontal: 52, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, progressTrack: { position: 'absolute', left: 14, right: 14, top: 21, height: 2, backgroundColor: '#DDDADD' }, progressTrackDone: { position: 'absolute', left: 14, top: 21, width: '33%', height: 2, backgroundColor: '#42A66C' }, step: { width: 31, height: 31, borderRadius: 16, backgroundColor: '#EDEBED', alignItems: 'center', justifyContent: 'center' }, stepDone: { backgroundColor: '#42A66C' }, stepActive: { backgroundColor: COLORS.primary }, stepNumber: { color: COLORS.text, fontSize: 14, fontWeight: '800' }, stepNumberActive: { color: '#FFF' }, stepLabels: { marginHorizontal: 18, flexDirection: 'row' }, stepLabel: { flex: 1, color: COLORS.muted, fontSize: 12, lineHeight: 18, textAlign: 'center' }, stepLabelActive: { color: COLORS.text, fontWeight: '800' },
  content: { paddingHorizontal: 14, paddingTop: 18, paddingBottom: 105, gap: 11 }, errorBox: { padding: 12, backgroundColor: COLORS.primarySoft, flexDirection: 'row', alignItems: 'center', gap: 8 }, errorText: { flex: 1, color: COLORS.primaryDark, fontSize: 14 },
  staffCard: { minHeight: 132, padding: 9, backgroundColor: '#FFF', flexDirection: 'row' }, staffImage: { width: 108, minHeight: 114, resizeMode: 'cover' }, fallback: { backgroundColor: COLORS.primarySoft, alignItems: 'center', justifyContent: 'center' }, initial: { color: COLORS.primary, fontSize: 34, fontWeight: '800' }, staffInfo: { flex: 1, paddingLeft: 14, paddingVertical: 4 }, rowBetween: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, staffName: { maxWidth: '60%', color: COLORS.text, fontSize: 19, fontWeight: '800' }, changeButton: { paddingHorizontal: 10, paddingVertical: 8, backgroundColor: COLORS.primarySoft }, changeText: { color: COLORS.primaryDark, fontSize: 13, fontWeight: '800' }, ratingRow: { marginTop: 8, flexDirection: 'row', alignItems: 'center', gap: 4 }, rating: { color: COLORS.text, fontSize: 14, fontWeight: '800' }, reviews: { color: COLORS.muted, fontSize: 13 }, metaRow: { marginTop: 10, flexDirection: 'row', alignItems: 'center', gap: 7 }, metaText: { flex: 1, color: COLORS.muted, fontSize: 13 },
  serviceCard: { minHeight: 94, padding: 9, backgroundColor: '#FFF', flexDirection: 'row', alignItems: 'center' }, serviceImage: { width: 78, height: 76, resizeMode: 'cover' }, serviceInfo: { flex: 1, alignSelf: 'stretch', paddingHorizontal: 12, paddingVertical: 3 }, serviceName: { color: COLORS.text, fontSize: 16, fontWeight: '800' }, serviceDescription: { color: COLORS.muted, fontSize: 13, marginTop: 5 }, serviceMeta: { marginTop: 'auto', flexDirection: 'row', alignItems: 'center', gap: 7 }, price: { color: COLORS.primaryDark, fontSize: 15, fontWeight: '800' }, separator: { color: '#AAA2A8', fontSize: 15 }, duration: { color: COLORS.muted, fontSize: 14 },
  panel: { padding: 14, backgroundColor: '#FFF' }, panelHeader: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, panelTitleRow: { flexDirection: 'row', alignItems: 'center', gap: 9 }, panelTitle: { color: COLORS.text, fontSize: 18, fontWeight: '800' }, monthNav: { flexDirection: 'row', alignItems: 'center', gap: 9 }, month: { color: COLORS.text, fontSize: 14, fontWeight: '700' }, weekdays: { marginTop: 17, flexDirection: 'row' }, weekday: { width: '14.285%', color: COLORS.muted, fontSize: 13, fontWeight: '700', textAlign: 'center' }, calendarGrid: { marginTop: 7, flexDirection: 'row', flexWrap: 'wrap' }, calendarDay: { width: '14.285%', height: 39, alignItems: 'center', justifyContent: 'center' }, calendarDayActive: { backgroundColor: COLORS.primary }, calendarDayText: { color: COLORS.text, fontSize: 14, fontWeight: '700' }, calendarDayDisabled: { color: '#C7C2C6', fontWeight: '500' }, calendarDayTextActive: { color: '#FFF' }, calendarDot: { width: 4, height: 4, borderRadius: 2, marginTop: 3, backgroundColor: '#EFA7B8' }, calendarDotActive: { backgroundColor: '#FFF' },
  timeGroup: { marginTop: 15 }, timeGroupTitle: { color: COLORS.text, fontSize: 15, fontWeight: '800', marginBottom: 8 }, slots: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 }, slot: { width: '23.2%', height: 42, borderWidth: 1, borderColor: '#DCD6DA', alignItems: 'center', justifyContent: 'center' }, slotDisabled: { backgroundColor: '#F7F5F6', borderColor: '#EEE9EC' }, slotActive: { backgroundColor: COLORS.primary, borderColor: COLORS.primary }, slotText: { color: COLORS.text, fontSize: 14 }, slotTextDisabled: { color: '#B9B2B7' }, slotTextActive: { color: '#FFF', fontWeight: '800' }, slotLoader: { height: 90 }, empty: { paddingVertical: 32, alignItems: 'center', gap: 8 }, noAvailability: { marginTop: 14, padding: 10, backgroundColor: '#EFF5F2', flexDirection: 'row', alignItems: 'center', gap: 7 }, noAvailabilityText: { flex: 1, color: COLORS.sage, fontSize: 13, lineHeight: 19 }, demoNotice: { marginTop: 14, padding: 10, backgroundColor: '#FFF2D9', flexDirection: 'row', alignItems: 'center', gap: 7 }, demoNoticeText: { flex: 1, color: '#866624', fontSize: 13, lineHeight: 19 }, notice: { minHeight: 62, marginTop: 16, paddingHorizontal: 10, backgroundColor: COLORS.primarySoft, flexDirection: 'row', alignItems: 'center', gap: 10 }, noticeIcon: { width: 28, height: 28, borderRadius: 14, backgroundColor: '#EF758E', alignItems: 'center', justifyContent: 'center' }, noticeMark: { color: '#FFF', fontSize: 17, fontWeight: '800' }, noticeText: { flex: 1, color: COLORS.muted, fontSize: 13, lineHeight: 20 }, noticeStrong: { color: COLORS.text, fontWeight: '800' },
