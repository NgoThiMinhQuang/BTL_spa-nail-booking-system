...
const styles = StyleSheet.create({
  ...
  center: { flex: 1, alignItems: 'center', justifyContent: 'center' }, loadingText: { color: COLORS.muted, fontSize: 14, marginTop: 12 }, content: { paddingHorizontal: 18, paddingBottom: 34 }, errorBox: { padding: 13, borderRadius: 14, backgroundColor: COLORS.soft, flexDirection: 'row', alignItems: 'center', gap: 9 }, errorText: { color: '#A24B64', fontSize: 14 },
  avatarSection: { alignItems: 'center', paddingVertical: 18 }, avatar: { width: 106, height: 106, borderRadius: 53, backgroundColor: COLORS.soft }, cameraButton: { position: 'absolute', top: 87, right: '35%', width: 34, height: 34, borderRadius: 17, backgroundColor: COLORS.pink, borderWidth: 3, borderColor: COLORS.background, alignItems: 'center', justifyContent: 'center' }, name: { color: COLORS.text, fontSize: 22, fontWeight: '800', marginTop: 13 }, member: { color: COLORS.pink, fontSize: 12, fontWeight: '800', letterSpacing: 1, marginTop: 5 },
  infoCard: { marginTop: 8, paddingHorizontal: 15, borderRadius: 20, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.line }, infoRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center' }, iconBox: { width: 42, height: 42, borderRadius: 13, backgroundColor: COLORS.soft, alignItems: 'center', justifyContent: 'center' }, infoCopy: { flex: 1, marginLeft: 13 }, label: { color: COLORS.muted, fontSize: 13, fontWeight: '600' }, value: { color: COLORS.text, fontSize: 15, fontWeight: '700', marginTop: 4 }, divider: { height: 1, marginLeft: 55, backgroundColor: COLORS.line },
