...
const styles = StyleSheet.create({
  ...
  header: { minHeight: 66, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, eyebrow: { color: COLORS.green, fontSize: 10, letterSpacing: 1.1, fontWeight: '800' }, title: { color: COLORS.text, fontSize: 27, fontWeight: '800', marginTop: 4 }, headerHeart: { width: 46, height: 46, borderRadius: 16, backgroundColor: COLORS.pinkSoft, alignItems: 'center', justifyContent: 'center' },
  summary: { minHeight: 76, marginTop: 13, paddingHorizontal: 13, borderRadius: 18, backgroundColor: '#E7F2EF', flexDirection: 'row', alignItems: 'center', gap: 11 }, summaryIcon: { width: 44, height: 44, borderRadius: 14, backgroundColor: '#FFF', alignItems: 'center', justifyContent: 'center' }, summaryCopy: { flex: 1 }, summaryTitle: { color: '#355F5A', fontSize: 14, fontWeight: '800' }, summaryText: { color: '#718A86', fontSize: 11, marginTop: 3 }, explore: { color: COLORS.pink, fontSize: 12, fontWeight: '800' },
  searchBox: { height: 50, marginTop: 16, paddingHorizontal: 14, borderRadius: 16, borderWidth: 1, borderColor: COLORS.line, backgroundColor: COLORS.surface, flexDirection: 'row', alignItems: 'center', gap: 9 }, searchInput: { flex: 1, color: COLORS.text, fontSize: 14 },
  sectionHeading: { marginTop: 22, marginBottom: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, sectionTitle: { color: COLORS.text, fontSize: 19, fontWeight: '800' }, resultCount: { color: COLORS.muted, fontSize: 12, fontWeight: '600' },
  grid: { flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between', rowGap: 14 }, card: { width: '48%', borderRadius: 18, backgroundColor: COLORS.surface, borderWidth: 1, borderColor: COLORS.line, overflow: 'hidden', shadowColor: '#865763', shadowOpacity: .07, shadowRadius: 9, shadowOffset: { width: 0, height: 4 }, elevation: 2 }, imageArea: { width: '100%', aspectRatio: 1.05 }, cardImage: { resizeMode: 'cover' }, trendingBadge: { position: 'absolute', left: 8, top: 8, height: 25, paddingHorizontal: 8, borderRadius: 9, backgroundColor: 'rgba(57,123,118,.88)', flexDirection: 'row', alignItems: 'center', gap: 4 }, trendingText: { color: '#FFF', fontSize: 8, fontWeight: '900' }, heartButton: { position: 'absolute', right: 8, top: 8, width: 34, height: 34, borderRadius: 17, backgroundColor: 'rgba(255,255,255,.93)', alignItems: 'center', justifyContent: 'center' },
  ...
  state: { minHeight: 340, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 28 }, stateIcon: { width: 72, height: 72, borderRadius: 25, backgroundColor: COLORS.pinkSoft, alignItems: 'center', justifyContent: 'center', marginBottom: 13 }, stateTitle: { color: COLORS.text, fontSize: 18, fontWeight: '800' }, stateText: { color: COLORS.muted, fontSize: 13, lineHeight: 20, textAlign: 'center', marginTop: 7 }, retryButton: { marginTop: 16, paddingHorizontal: 22, paddingVertical: 11, borderRadius: 20, backgroundColor: COLORS.pinkSoft }, retryText: { color: COLORS.pink, fontSize: 13, fontWeight: '800' }, bookButton: { height: 44, marginTop: 18, paddingHorizontal: 22, borderRadius: 22, backgroundColor: COLORS.pink, alignItems: 'center', justifyContent: 'center' }, bookText: { color: '#FFF', fontSize: 13, fontWeight: '800' },
});
