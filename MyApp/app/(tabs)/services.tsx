...
const categories: {
  id: CategoryId;
  label: string;
  icon: "infinity" | "bottle-tonic" | "brush" | "diamond-stone";
}[] = [
    ...
    <View style={[styles.card, { borderLeftColor: meta.color }]}>
          ...
          <Image
            source={
              service.imageUrl
                ...
                : require("@/assets/images/nails/nail-collection-v2.png")
            }
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.priceRow}>
            ...
            <View style={styles.duration}>
              <Ionicons name="time-outline" size={14} color="#7D7477" />
      ...
      <View style={styles.actions}>
        <Pressable
          ...
          style={[styles.secondaryButton, { backgroundColor: meta.softColor }]}
        >
          <Ionicons name="eye-outline" size={15} color={meta.color} />
          <Text style={[styles.secondaryText, { color: meta.color }]}>
            Xem chi tiết
          </Text>
        </Pressable>
        <Pressable
        ...
        >
          ...
          <Text style={styles.primaryText}>Chọn dịch vụ</Text>
        </Pressable>
      </View>
    </View>
  );
  ...
  const filteredServices = useMemo(
    () =>
      services.filter((service) => {
        ...
        const categoryText =
          service.categoryName?.toLocaleLowerCase("vi") ?? "";
        const matchesCategory =
          category === "all" ||
          (category === "gel" && categoryText.includes("gel")) ||
          (category === "art" && categoryText.includes("art")) ||
          (category === "extension" &&
            (categoryText.includes("đắp") || categoryText.includes("móng")));
    ...
    <SafeAreaView edges={["top"]} style={styles.safeArea}>
      ...
      >
        <View style={styles.header}>
          <View>
            <View style={styles.brandRow}>
              <Ionicons name="flower-outline" size={21} color="#D56B81" />
              <Text style={styles.brand}>
                Nail<Text style={styles.brandAccent}>House</Text>
              </Text>
            </View>
            <View style={styles.locationRow}>
              <Ionicons name="location-outline" size={12} color="#557A75" />
        ...
        <View style={styles.intro}>
          <View>
            <Text style={styles.kicker}>HAUTE BEAUTÉ</Text>
            <Text style={styles.title}>Dịch vụ Nail</Text>
          </View>
          <View style={styles.designCount}>
        ...
        <View style={styles.filtersArea}>
          <View style={styles.searchBox}>
            <Ionicons name="search" size={20} color="#81787B" />
            <TextInput
              value={query}
              onChangeText={setQuery}
              placeholder="Tìm dịch vụ sơn, vẽ móng, dưỡng da tay..."
        ...
        <View style={styles.serviceList}>
          {loading && services.length === 0 && (
            <View style={styles.empty}>
              <ActivityIndicator size="large" color="#397B76" />
          ...
          {!loading && !error && filteredServices.length === 0 && (
            <View style={styles.empty}>
              <Ionicons name="search-outline" size={34} color="#79938E" />
              <Text style={styles.emptyTitle}>Không tìm thấy dịch vụ</Text>
              <Text style={styles.emptyText}>
                Thử từ khóa hoặc danh mục khác nhé.
              </Text>
            </View>
          )}
        </View>
...
const styles = StyleSheet.create({
  ...
  brand: { color: "#333033", fontSize: 20, fontWeight: "700" },
  brandAccent: { color: "#D56B81" },
  locationRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: 3,
  ...
  avatarText: { color: "#397B76", fontSize: 15, fontWeight: "800" },
  intro: {
    paddingHorizontal: 18,
    marginBottom: 14,
    flexDirection: "row",
  ...
  title: { color: "#30282B", fontSize: 28, fontWeight: "800", marginTop: 3 },
  designCount: {
  ...
  designCountText: { color: "#A04763", fontSize: 12, fontWeight: "700" },
  filtersArea: { backgroundColor: "#FBFAF6", paddingBottom: 12 },
  searchBox: {
    marginHorizontal: 18,
    height: 45,
    borderRadius: 14,
  ...
  input: { flex: 1, color: "#332D2F", fontSize: 14 },
  categoryList: { paddingHorizontal: 18, paddingTop: 12, gap: 8 },
  category: {
  ...
  activeCategory: { backgroundColor: "#D56B81" },
  categoryText: { color: "#665D60", fontSize: 13, fontWeight: "700" },
  activeCategoryText: { color: "#FFF" },
  serviceList: { paddingHorizontal: 16, gap: 14 },
  card: {
    backgroundColor: "#FFF",
    borderRadius: 20,
    padding: 12,
  ...
  serviceImage: { width: 105, height: 105, borderRadius: 14 },
  imageBadge: {
    position: "absolute",
    left: 6,
    top: 6,
  ...
  imageBadgeText: { color: "#FFF", fontSize: 11, fontWeight: "800" },
  ...
  rating: { color: "#4C4346", fontSize: 12, fontWeight: "700" },
  reviews: { color: "#998F92", fontSize: 11 },
  serviceName: {
    color: "#30272A",
    fontSize: 18,
    fontWeight: "800",
  ...
  description: { color: "#82777A", fontSize: 12, lineHeight: 19, marginTop: 4 },
  priceRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  durationText: { color: "#7D7477", fontSize: 11 },
  ...
  emptyText: { color: "#867C7F", fontSize: 13, marginTop: 4 },
  errorBox: {
    marginTop: 8,
    borderRadius: 16,
    padding: 18,
