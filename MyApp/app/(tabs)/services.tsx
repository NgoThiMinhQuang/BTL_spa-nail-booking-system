...
const styles = StyleSheet.create({
  ...
  locationRow: { flexDirection: 'row', alignItems: 'center', gap: 3, marginTop: 3, marginLeft: 26 }, location: { color: '#697775', fontSize: 11, letterSpacing: .55, fontWeight: '700' },
  ...
  intro: { paddingHorizontal: 18, marginBottom: 14, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' }, kicker: { color: '#708D86', fontSize: 11, letterSpacing: 1.1, fontWeight: '800' }, title: { color: '#30282B', fontSize: 28, fontWeight: '800', marginTop: 3 },
  designCount: { backgroundColor: '#F7E9ED', borderRadius: 16, paddingHorizontal: 11, paddingVertical: 7, flexDirection: 'row', alignItems: 'center', gap: 5 }, designCountText: { color: '#A04763', fontSize: 12, fontWeight: '700' },
  filtersArea: { backgroundColor: '#FBFAF6', paddingBottom: 12 }, searchBox: { marginHorizontal: 18, height: 45, borderRadius: 14, backgroundColor: '#FFF', borderWidth: 1, borderColor: '#E9E5DF', paddingHorizontal: 13, flexDirection: 'row', alignItems: 'center', gap: 9 }, input: { flex: 1, color: '#332D2F', fontSize: 14 },
  categoryList: { paddingHorizontal: 18, paddingTop: 12, gap: 8 }, category: { paddingHorizontal: 14, height: 38, borderRadius: 19, backgroundColor: '#F0EEE8', flexDirection: 'row', alignItems: 'center', gap: 6 }, activeCategory: { backgroundColor: '#D56B81' }, categoryText: { color: '#665D60', fontSize: 13, fontWeight: '700' }, activeCategoryText: { color: '#4D3540' },
  serviceList: { paddingHorizontal: 16, gap: 14 }, card: { backgroundColor: '#FFF', borderRadius: 20, padding: 12, borderLeftWidth: 4, borderWidth: 1, borderColor: '#EFEAE5' }, cardMain: { flexDirection: 'row', gap: 12 }, serviceImage: { width: 105, height: 105, borderRadius: 14 }, imageBadge: { position: 'absolute', left: 6, top: 6, paddingHorizontal: 7, paddingVertical: 4, borderRadius: 8 }, imageBadgeText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
  cardContent: { flex: 1, paddingTop: 2 }, cardTopRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }, eyebrow: { maxWidth: '55%', fontSize: 11, letterSpacing: .55, fontWeight: '800' }, ratingRow: { flexDirection: 'row', alignItems: 'center', gap: 2 }, rating: { color: '#4C4346', fontSize: 12, fontWeight: '700' }, reviews: { color: '#998F92', fontSize: 11 },
  serviceName: { color: '#30272A', fontSize: 18, fontWeight: '800', marginTop: 8 }, description: { color: '#82777A', fontSize: 12, lineHeight: 19, marginTop: 4 }, priceRow: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 7 }, price: { fontSize: 17, fontWeight: '800' }, duration: { flexDirection: 'row', alignItems: 'center', gap: 3 }, durationText: { color: '#7D7477', fontSize: 11 },
  actions: { flexDirection: 'row', gap: 9, marginTop: 12 }, secondaryButton: { flex: .85, height: 38, borderRadius: 19, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 }, secondaryText: { fontSize: 12, fontWeight: '700' }, primaryButton: { flex: 1.15, height: 38, borderRadius: 19, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 }, primaryText: { color: '#FFF', fontSize: 12, fontWeight: '800' },
  empty: { alignItems: 'center', paddingVertical: 48 }, emptyTitle: { color: '#3D3437', fontSize: 16, fontWeight: '800', marginTop: 9 }, emptyText: { color: '#867C7F', fontSize: 13, marginTop: 4 },
  errorBox: { marginTop: 8, borderRadius: 16, padding: 18, alignItems: 'center', gap: 7, backgroundColor: '#F9ECE8' }, errorText: { color: '#7C4A41', fontSize: 13, textAlign: 'center', lineHeight: 21 }, retryText: { color: '#397B76', fontWeight: '800', fontSize: 14, marginTop: 3 },
});
