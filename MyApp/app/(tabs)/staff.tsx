...
const styles = StyleSheet.create({
  ...
  brandNote: { color: COLORS.muted, fontSize: 11, marginTop: -1 },
  ...
  eyebrowText: { color: COLORS.primaryDark, fontSize: 11, fontWeight: '800', letterSpacing: 1.1 },
  title: { marginTop: 7, color: COLORS.ink, fontSize: 34, lineHeight: 39, fontWeight: '800', fontFamily: 'serif' },
  subtitle: { marginTop: 5, color: '#635962', fontSize: 13, lineHeight: 21 },
  ...
  availableText: { color: COLORS.sage, fontSize: 11, fontWeight: '700' },
  ...
  workBadgeText: { color: COLORS.sage, fontSize: 11, fontWeight: '800' },
  ...
  lovedText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
  cardBody: { padding: 11 },
  name: { color: COLORS.ink, fontSize: 15, fontWeight: '800' },
  role: { marginTop: 2, fontSize: 11, fontWeight: '700' },
  ...
  experience: { color: COLORS.muted, fontSize: 11 },
  ...
  detailText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
  ...
  errorText: { flex: 1, color: '#8B584D', fontSize: 11 },
  ...
  suggestionTitle: { color: COLORS.lavender, fontSize: 13, fontWeight: '800' },
  suggestionText: { color: COLORS.muted, fontSize: 11, marginTop: 2 },
  ...
  suggestionButtonText: { color: '#FFF', fontSize: 11, fontWeight: '800' },
});
