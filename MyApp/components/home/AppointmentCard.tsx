...
const styles = StyleSheet.create({ card: { marginHorizontal: 16, padding: 10, backgroundColor: '#FFF', borderRadius: 14, flexDirection: 'row', gap: 12, borderWidth: 1, borderColor: '#F2E4E8' }, image: { width: 74, height: 74, borderRadius: 10 }, placeholder: { width: 74, height: 74, borderRadius: 10, backgroundColor: '#F6E9ED', alignItems: 'center', justifyContent: 'center' }, content: { flex: 1, justifyContent: 'center' }, service: { color: '#392C30', fontSize: 15, fontWeight: '800' }, staff: { color: '#796A6F', fontSize: 12, marginTop: 3 }, row: { flexDirection: 'row', alignItems: 'center', gap: 5, marginTop: 5 }, time: { flex: 1, color: '#7C6B71', fontSize: 12 }, status: { marginTop: 7, alignSelf: 'flex-start', backgroundColor: '#E7F4EB', borderRadius: 9, paddingHorizontal: 8, paddingVertical: 3 }, statusText: { color: '#398251', fontSize: 11, fontWeight: '700' } });
