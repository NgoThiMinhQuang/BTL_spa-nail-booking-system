...
const styles = StyleSheet.create({ row: { flexDirection: 'row', paddingHorizontal: 10, paddingTop: 24, paddingBottom: 3 }, item: { flex: 1, alignItems: 'center', paddingHorizontal: 3 }, icon: { width: 54, height: 54, borderRadius: 27, alignItems: 'center', justifyContent: 'center', marginBottom: 9 }, label: { color: '#352B2E', fontSize: 14, fontWeight: '800' }, note: { color: '#8D7B81', fontSize: 11, marginTop: 4, maxWidth: 78 } });
